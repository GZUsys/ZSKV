...
Status FlushJob::Run(LogsWithPrepTracker* prep_tracker, FileMetaData* file_meta,
                     ...
                     ErrorHandler* error_handler,SegmentManager* segment_manager) {
  ...
  if (mempurge_s.ok()) {
    ...
    s = WriteLevel0Table(segment_manager);
  }
...
Status FlushJob::WriteLevel0Table(SegmentManager* segment_manager) {
                                             ...
                                             1 /* count**/);
  {
...

    {
      ...
      s = BuildTable(
          ...
          &memtable_garbage_bytes, &flush_stats,segment_manager);
