...
void ArenaWrappedDBIter::Init(
    ...
    bool expose_blob_index, bool allow_refresh, ReadOnlyMemTable* active_mem,L2PMap* l2p_map,
  ...
  db_iter_ = DBIter::NewIter(
      ...
      read_callback, active_mem,l2p_map,zns_manager, cfh, expose_blob_index, &arena_);
...
ArenaWrappedDBIter* NewArenaWrappedDbIterator(
    ...
    bool allow_refresh, bool allow_mark_memtable_for_flush,L2PMap* l2p_map,
    ZNSManager* zns_manager) {
  ...
  db_iter->Init(env, read_options, cfh->cfd()->ioptions(),
                ...
                allow_refresh,
                allow_mark_memtable_for_flush ? sv->mem : nullptr,l2p_map,
                zns_manager);
