...
class ArenaWrappedDBIter : public Iterator {
 public:
  ...
  void Init(Env* env, const ReadOptions& read_options,
            ...
            ReadOnlyMemTable* active_mem,L2PMap* l2p_map = nullptr,
            ZNSManager* zns_manager = nullptr);
...
ArenaWrappedDBIter* NewArenaWrappedDbIterator(
  ...
  bool allow_refresh, bool allow_mark_memtable_for_flush, L2PMap* l2p_map = nullptr, ZNSManager* zns_manager = nullptr);
}  // namespace ROCKSDB_NAMESPACE
