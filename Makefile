...
# libzbd 的头文件路径（通常在 /usr/include）
LIBZBD_INCLUDE_PATH = /usr/include

# libzbd 的库文件路径（你这边是在 /usr/lib）
LIBZBD_LIB_PATH = /usr/lib

# 加入编译器的头文件搜索路径
CXXFLAGS += -I$(LIBZBD_INCLUDE_PATH)


# 加入链接器的库搜索路径，并链接 libzbd
LDFLAGS += -L$(LIBZBD_LIB_PATH) -lzbd
